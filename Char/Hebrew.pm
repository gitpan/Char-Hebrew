...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ehebrew::function_ord     = 'Char::Hebrew::ord'     if /\A ord \z/oxms;
                    $Char::Ehebrew::function_ord_    = 'Char::Hebrew::ord_'    if /\A ord \z/oxms;
                    $Char::Ehebrew::function_reverse = 'Char::Hebrew::reverse' if /\A reverse \z/oxms;
                    $Char::Ehebrew::function_getc    = 'Char::Hebrew::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Hebrew::escape();
...
=head1 Calling 'Char::Ehebrew::ignorecase()' (Char::Hebrew software provides)

Char::Hebrew software applies calling 'Char::Ehebrew::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Hebrew software provides)

Char::Hebrew software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Hebrew software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Hebrew software provides)

Char::Hebrew software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Hebrew software and
