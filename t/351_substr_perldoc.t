...
my $color  = Char::Hebrew::substr $s, 4, 5;   # black
my $middle = Char::Hebrew::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Hebrew::substr $s, 14;     # climebed the green tree
my $tail   = Char::Hebrew::substr $s, -4;     # tree
my $z      = Char::Hebrew::substr $s, -4, 2;  # tr
