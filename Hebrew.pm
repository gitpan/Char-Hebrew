...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Hebrew software provides)

Hebrew software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Hebrew software provide)
